...
(deftest clj-2656-nondeterministic-interface-dispatch-test
  ...
  (testing "JInterface2, JInterface1"
    (is (= :JInterface2 (unambiguous-method (JavaProtocolExtension$JExtension2.))))
  ...
  (testing "JInterfaceExtends1, JInterfaceExtends2"
    ...
    (is (= :JInterfaceExtends2 (unambiguous-method (reify JavaProtocolExtension$JInterfaceExtends1 JavaProtocolExtension$JInterfaceExtends2))))
    ...
    (is (= :JInterfaceExtends2 (unambiguous-method (TExtension5.))))
    (is (= :JInterfaceExtends2 (unambiguous-method (RExtension5.)))))
  (testing "JInterfaceExtends2, JInterfaceExtends1"
    (is (= :JInterfaceExtends2 (unambiguous-method (JavaProtocolExtension$JExtension6.))))
    (is (= :JInterfaceExtends2 (unambiguous-method (reify JavaProtocolExtension$JInterfaceExtends2 JavaProtocolExtension$JInterfaceExtends1))))
    ...
    (is (= :JInterfaceExtends2 (unambiguous-method (TExtension6.))))
    (is (= :JInterfaceExtends2 (unambiguous-method (RExtension6.)))))
  ...
  (testing "JInterface1, JInterfaceExtends1, JInterface2, JInterfaceExtends2"
    ...
    (is (= :JInterfaceExtends1 (unambiguous-method (proxy [JavaProtocolExtension$JInterface1
                                                           ...
                                                           JavaProtocolExtension$JInterfaceExtends2]
                                                     []))))
    (is (= :JInterfaceExtends2 (unambiguous-method (TExtension9.))))
    (is (= :JInterfaceExtends2 (unambiguous-method (RExtension9.)))))
  (testing "JInterface2, JInterfaceExtends2, JInterface1, JInterfaceExtends1"
    (is (= :JInterfaceExtends2 (unambiguous-method (JavaProtocolExtension$JExtension10.))))
    (is (= :JInterfaceExtends2 (unambiguous-method (reify
                                                     JavaProtocolExtension$JInterface2
                                                     JavaProtocolExtension$JInterfaceExtends2
                                                     JavaProtocolExtension$JInterface1
    ...
    (is (= :JInterfaceExtends1 (unambiguous-method (proxy [JavaProtocolExtension$JInterface2
                                                           ...
                                                           JavaProtocolExtension$JInterfaceExtends1]
                                                     []))))
    (is (= :JInterfaceExtends2 (unambiguous-method (TExtension10.))))
    (is (= :JInterfaceExtends2 (unambiguous-method (RExtension10.)))))
  (testing "JInterface2, JInterfaceExtends1, JInterface1, JInterfaceExtends2"
    (is (= :JInterfaceExtends2 (unambiguous-method (JavaProtocolExtension$JExtension11.))))
    ...
    (is (= :JInterfaceExtends1 (unambiguous-method (proxy [JavaProtocolExtension$JInterface2
                                                           ...
                                                           JavaProtocolExtension$JInterfaceExtends2]
                                                     []))))
    (is (= :JInterfaceExtends2 (unambiguous-method (TExtension11.))))
    (is (= :JInterfaceExtends2 (unambiguous-method (RExtension11.)))))
  (testing "JInterfaceExtends1, JInterface1, JInterfaceExtends2, JInterface2"
    ...
    (is (= :JInterfaceExtends1 (unambiguous-method (proxy [JavaProtocolExtension$JInterfaceExtends1
                                                           ...
                                                           JavaProtocolExtension$JInterface2]
                                                     []))))
    (is (= :JInterfaceExtends2 (unambiguous-method (TExtension12.))))
    (is (= :JInterfaceExtends2 (unambiguous-method (RExtension12.)))))
  ...
  (testing "extends JExtension2"
    (is (= :JInterface2 (unambiguous-method (JavaProtocolExtension$JSubExtension2.))))
    (is (= :JInterface2 (unambiguous-method (proxy [JavaProtocolExtension$JExtension2] [])))))
