...
(deftest arity-exceptions
  ...
  (is (thrown-with-msg? IllegalArgumentException #"Wrong number of args \(21\+\) passed to: :foo/bar" (apply :foo/bar (range 22))))
  (is (thrown-with-msg? IllegalArgumentException #"Wrong number of args \(21\+\) passed to: :foo/bar" (apply :foo/bar (range)))))
