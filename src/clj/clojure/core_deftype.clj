    ...
    (let [c (class x)
      ...
      (or (impl c)
          (and c (or (first (remove nil? (map impl (butlast (super-chain c)))))
                     ;; find the first interface that extends the protocol via an in-order depth-first search of c's
                     ;; interface hierarchy at each superclass level, then continue the search and replace the most-specific interface
